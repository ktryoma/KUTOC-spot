...
def get_command_dict(instance):
    return {
        ...
        "まて": instance._stop_follow,
        "待て": instance._stop_follow,
        ...
        "ありがとう": instance._spot_find_dock,
        "回って": instance._spot_rotate,
        "まわって": instance._spot_rotate,
        "回転": instance._spot_rotate,
        "をまわり": instance._spot_rotate,
        "お巡り": instance._spot_rotate,
        "登場": instance._spot_finish_dock,
        ...
        "伏せ": instance._spot_squat,
        "伏せて": instance._spot_squat,
